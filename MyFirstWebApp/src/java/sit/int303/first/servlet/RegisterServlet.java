...
public class RegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String emailInDb = register.getEmail();
        String activateKeyInDb = register.getActivatekey();
        request.setAttribute("email", emailInDb);
        request.setAttribute("activatekey", activateKeyInDb);
